            ...
            $testCases | %{
                ...
                if (Test-Path $repositoryPath) {
                    ...
                    Get-ChildItem $repositoryPath\* -Include *.dgml,*.nuspec | %{
                        ...
                        {
                            $logData = [System.IO.File]::ReadAllText($generatePackagesOutputLogFilePath)

                            DebugLogRaw $debugLogFilePath $logData
                        }

                        If (Test-Path $generatePackagesErrorLogFilePath)
                        {
                            $logData = [System.IO.File]::ReadAllText($generatePackagesErrorLogFilePath)
